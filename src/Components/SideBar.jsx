...
const SideBar = ({ setGenre }) => {
  return (
    <div className="sidecss">
       <aside id="default-sidebar" className="hidden sm:block sm:mt-[120px] md:mt-16 z-0 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-800">
          <h1 className="text-center text-3xl pb-2 border-b font-bold text-white">
            Genres
          </h1>
          <ul className="space-y-2 font-medium">
            {["Action", "Adventure", "Comedy", "Horror", "Thriller","Science fiction","Fantasy","Historical film","Crime","Romantic comedy", "Animation"].map((genre) => (
              <li key={genre}>
                <button
